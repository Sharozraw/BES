  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(circle at 20% 20%, rgba(200,153,42,0.08) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(21,101,192,0.08) 0%, transparent 50%)',
        pointerEvents: 'none'
      }} />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
              Admin: <code style={{ fontFamily: 'IBM Plex Mono, monospace', color: 'var(--navy)' }}>admin@bes.gov.lk</code>
              {' / '}<code style={{ fontFamily: 'IBM Plex Mono, monospace' }}>Admin@1234</code>
            </p>
            <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginTop: '4px' }}>
              Evaluator: <code style={{ fontFamily: 'IBM Plex Mono, monospace', color: 'var(--navy)' }}>evaluator@bes.gov.lk</code>
              {' / '}<code style={{ fontFamily: 'IBM Plex Mono, monospace' }}>Eval@1234</code>
            </p>
          </div>
        </div>
