      ...
      <div style={{ maxWidth: '700px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 24px' }}>
              {[
                ...
                <div key={label} style={{ padding: '12px 0', borderBottom: '1px solid var(--border-light)' }}>
                  <div style={{ fontSize: '11px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '4px', letterSpacing: '0.3px' }}>{label}</div>
                  <div style={{ fontSize: '13.5px', color: 'var(--text)', fontWeight: '500' }}>{value || '—'}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-header">
            <span className="card-title"><Lock size={15} style={{ display: 'inline', marginRight: '6px' }} />Change Password</span>
          </div>
          <div className="card-body">
            <form onSubmit={handleChangePassword}>
              ...
              <button type="submit" className="btn btn-navy" disabled={saving}>
                {saving ? 'Saving...' : <><Save size={15} /> Update Password</>}
              </button>
            </form>
          </div>
        </div>
